...
//      name is taken test: add account then see if you can add another acccount with same name
...
//        Password Test:
//        Test For: null, empty string, string of size 1, string of size 2, string of size 3, string of size 4, string of size 5
...
//        Test For: null, empty string, string of size 1, string of size 2, string of size 3, string of size 4, string of size 5
        ...
        Assert.assertSame("RESULT INCORRECT: Adding an account with Contact Info with @ and .",
                RegistrationResultENUM.SUCCESS,
                accountManager.addToAccounts("july2", "1234a", "@.", UserTypeENUM.USER));
    }
